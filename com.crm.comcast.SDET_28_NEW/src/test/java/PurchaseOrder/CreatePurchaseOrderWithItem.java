...
public class CreatePurchaseOrderWithItem {
	...
	pruchase = pruchase+RandomNumber();
	...
	driver.findElement(By.xpath("//textarea[@name=\"bill_street\"]")).sendKeys("Bangalore"+rannum);
	driver.findElement(By.xpath("//textarea[@name=\"ship_street\"]")).sendKeys("Mysore"+rannum);
